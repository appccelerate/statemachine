...
namespace Appccelerate.StateMachine.AsyncMachine
{
        ...
        where TEvent : IComparable
    {
        ...
        /// <summary>
        /// Saves the current state and history states to a persisted state. Can be restored using <see cref="Load(Appccelerate.StateMachine.Persistence.IAsyncStateMachineLoader{TState,TEvent})"/>.
        /// </summary>
        ...
        /// <summary>
        /// Loads the current state and history states from a persisted state (<see cref="Save(Appccelerate.StateMachine.Persistence.IAsyncStateMachineSaver{TState,TEvent})"/>).
