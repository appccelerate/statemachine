//-------------------------------------------------------------------------------
// <copyright file="StandardFactoryNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine
{
    ...
    public class StandardFactoryNew<TState, TEvent> : IFactoryNew<TState, TEvent>
        ...
        where TEvent : IComparable
    {
        ...
        public virtual ITransitionContextNew<TState, TEvent> CreateTransitionContext(IStateDefinition<TState, TEvent> state, Missable<TEvent> eventId, object eventArgument, INotifierNew<TState, TEvent> notifier)
        {
            return new TransitionContextNew<TState, TEvent>(state, eventId, eventArgument, notifier);
        }

        public virtual StateMachineInitializerNew<TState, TEvent> CreateStateMachineInitializer(IStateDefinition<TState, TEvent> initialState, ITransitionContextNew<TState, TEvent> context)
        {
            return new StateMachineInitializerNew<TState, TEvent>(initialState, context);
        }
    }
}