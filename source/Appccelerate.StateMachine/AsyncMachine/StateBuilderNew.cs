//-------------------------------------------------------------------------------
// <copyright file="StateBuilderNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine
{
        ...
        where TEvent : IComparable
    {
        ...
        private StateBuilderNew<TState, TEvent> ExecuteInternal(Func<Task> action)
        {
        ...
        private StateBuilderNew<TState, TEvent> ExecuteInternal<T>(Func<T, Task> action)
        {
            this.currentTransitionDefinition.ActionsModifiable.Add(this.factory.CreateTransitionActionHolder(action));
