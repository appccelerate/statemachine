//-------------------------------------------------------------------------------
// <copyright file="TransitionContextNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine.Contexts
{
    ...
    public class TransitionContextNew<TState, TEvent> : ITransitionContextNew<TState, TEvent>
        where TState : IComparable
        where TEvent : IComparable
    {
        private readonly List<Record> records;

        public TransitionContextNew(IStateDefinition<TState, TEvent> stateDefinition, Missable<TEvent> eventId, object eventArgument, INotifierNew<TState, TEvent> notifier)
        {
        ...
        private INotifierNew<TState, TEvent> Notifier { get; }
