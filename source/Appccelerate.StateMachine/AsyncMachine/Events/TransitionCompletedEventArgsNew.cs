//-------------------------------------------------------------------------------
// <copyright file="TransitionCompletedEventArgsNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine.Events
{
    ...
    public class TransitionCompletedEventArgsNew<TState, TEvent>
        : TransitionEventArgsNew<TState, TEvent>
        where TState : IComparable
        where TEvent : IComparable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitionCompletedEventArgsNew&lt;TState, TEvent&gt;"/> class.
        /// </summary>
        /// <param name="newStateId">The new state id.</param>
        /// <param name="context">The context.</param>
        public TransitionCompletedEventArgsNew(TState newStateId, ITransitionContextNew<TState, TEvent> context)
            : base(context)
        {
