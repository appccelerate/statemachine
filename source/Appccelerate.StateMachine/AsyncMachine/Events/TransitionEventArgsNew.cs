//-------------------------------------------------------------------------------
// <copyright file="TransitionEventArgsNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine.Events
{
    ...
    public class TransitionEventArgsNew<TState, TEvent>
        : ContextEventArgsNew<TState, TEvent>
        where TState : IComparable
        where TEvent : IComparable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitionEventArgsNew&lt;TState, TEvent&gt;"/> class.
        /// </summary>
        /// <param name="context">The event context.</param>
        public TransitionEventArgsNew(ITransitionContextNew<TState, TEvent> context)
            : base(context)
        {
        }
