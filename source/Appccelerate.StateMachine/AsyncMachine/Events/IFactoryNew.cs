//-------------------------------------------------------------------------------
// <copyright file="IFactoryNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine.AsyncMachine.Events
{
    ...
    public interface IFactoryNew<TState, TEvent>
        ...
        where TEvent : IComparable
    {
        ...
        ITransitionContextNew<TState, TEvent> CreateTransitionContext(IStateDefinition<TState, TEvent> stateDefinition, Missable<TEvent> eventId, object eventArgument, INotifierNew<TState, TEvent> notifier);

        StateMachineInitializerNew<TState, TEvent> CreateStateMachineInitializer(IStateDefinition<TState, TEvent> initialState, ITransitionContextNew<TState, TEvent> context);
    }
}