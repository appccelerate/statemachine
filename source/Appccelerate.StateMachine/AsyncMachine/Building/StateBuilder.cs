...
namespace Appccelerate.StateMachine.AsyncMachine.Building
{
        ...
        where TEvent : notnull
    {
        ...
        private BuildableTransitionDefinition<TState, TEvent>? currentTransitionDefinition;

        private TEvent currentEventId = default!;

        public StateBuilder(
            TState stateId,
            ImplicitAddIfNotAvailableStateDefinitionDictionary<TState, TEvent> stateDefinitionDictionary,
        ...
        IEntryActionSyntax<TState, TEvent> IEntryActionSyntax<TState, TEvent>.ExecuteOnEntry(Func<Task> action)
        {
            ...
            this.stateDefinition.EntryActions.Add(this.factory.CreateActionHolder(action));
        ...
        {
            this.stateDefinition.EntryActions.Add(this.factory.CreateActionHolder(action, parameter));
        ...
        IExitActionSyntax<TState, TEvent> IExitActionSyntax<TState, TEvent>.ExecuteOnExit(Func<Task> action)
        {
            ...
            this.stateDefinition.ExitActions.Add(this.factory.CreateActionHolder(action));
        ...
        {
            this.stateDefinition.ExitActions.Add(this.factory.CreateActionHolder(action, parameter));
        ...
        {
            this.currentTransitionDefinition = new BuildableTransitionDefinition<TState, TEvent>(
                this.currentEventId);
            this.stateDefinition.Transitions.Add(this.currentTransitionDefinition);
        }
        ...
        {
            this.currentTransitionDefinition!.Actions.Add(this.factory.CreateTransitionActionHolder(action));
        ...
        {
            var transitionsByEvent = this.stateDefinition
                .Transitions
                .GroupBy(t => t.Event)
                .ToList();
            var withMoreThenOneTransitionWithoutGuard = transitionsByEvent
                .Where(g =>
                    g.Count(t => t.Guard == null) > 1);
