namespace Appccelerate.StateMachine.Machine
{
        ...
        where TEvent : IComparable
    {
        ...
        public SyntaxStart(IStateDictionary<TState, TEvent> stateDefinitionDictionary, IDictionary<TState, IStateDefinition<TState, TEvent>> initiallyLastActiveStates)
        {
        ...
        {
            return new StateBuilder<TState, TEvent>(stateId, this.stateDefinitionDictionary);
        }
