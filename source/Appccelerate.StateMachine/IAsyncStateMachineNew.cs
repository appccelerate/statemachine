//-------------------------------------------------------------------------------
// <copyright file="IAsyncStateMachineNew.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine
{
    ...
    public interface IAsyncStateMachineNew<TState, TEvent>
        ...
        where TEvent : IComparable
    {
        ...
        /// </summary>
        event EventHandler<TransitionEventArgsNew<TState, TEvent>> TransitionDeclined;

        /// <summary>
        /// Occurs when an exception was thrown inside a transition of the state machine.
        /// </summary>
        event EventHandler<TransitionExceptionEventArgsNew<TState, TEvent>> TransitionExceptionThrown;

        /// <summary>
        /// Occurs when a transition begins.
        /// </summary>
        event EventHandler<TransitionEventArgsNew<TState, TEvent>> TransitionBegin;

        /// <summary>
        /// Occurs when a transition completed.
        /// </summary>
        event EventHandler<TransitionCompletedEventArgsNew<TState, TEvent>> TransitionCompleted;
        ...
        void Report(IStateMachineReportNew<TState, TEvent> reportGenerator);
